...
use Shanginn\LaravelOpenApi\Attributes;
use Shanginn\LaravelOpenApi\Attributes\Collection as CollectionAttribute;
use Shanginn\LaravelOpenApi\Builders\Paths\OperationsBuilder;
use Shanginn\LaravelOpenApi\Contracts\PathMiddleware;
